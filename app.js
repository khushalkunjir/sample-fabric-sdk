...
app.post('/channels/:channelName/chaincodes/:chaincodeName', async function (req, res) {
    try {
        ...
        let response_payload = await invoke.invokeTransaction(channelName, chaincodeName, fcn, args, req.username, req.orgname, transient);
...
app.get('/channels/:channelName/chaincodes/:chaincodeName', async function (req, res) {
    try {
        ...
        let response_payload = await query.query(channelName, chaincodeName, args, fcn, req.username, req.orgname);
